...
<li><a href="index1.php?pt=<?=$data2['pt_id'];?>" class="btn btn-outline-dark"><?=$data2['pt_name'];?></a> </li>
...
if (isset($_POST['Submit'])) {
  ...
  $str = "INSERT INTO contact VALUES('','$subj','$name','$email','$msg',CURRENT_TIMESTAMP)";
  mysqli_query($conn,$str);

  echo "<script>
          alert('เราได้รับข้อมูลจากคุณแล้วขอบคุณที่เป็นส่วนหนึ่งใน DW');
