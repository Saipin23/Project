...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="id" name="id" type="text" placeholder="" class="form-control input-md" readonly value="<?=$data['p_id'];?>">   
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="p_name" name="p_name" type="text" placeholder="" class="form-control input-md" required value="<?=$data['p_name'];?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
   <input id="color" name="color" type="text" placeholder="" class="form-control input-md" required value="<?=$data['p_price'];?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="p_price" name="p_price" type="text" placeholder="" class="form-control input-md" required value="<?=$data['p_price'];?>">
...
if (isset($_POST['Submit'])){
	include("connectdb.php");
	$sql = "UPDATE product SET p_name='".$_POST['p_name']."',color='".$_POST['color']."', p_detail='".$_POST['p_detail']."', p_price='".$_POST['p_price']."' where p_id='".$_GET['id']."' ";
